    		...
    		switch(
    		    ...
    		    'remove' = {
		            for (i in 1:length(x)) {
			            ...
			            raise.error('Invalid na option: valid options are "none", "stop", and "remove"');
		                }
    		    );
    		...
    		switch(
                ...
                '5' = {
        			...
        			grob.list <- VennDiagram::draw.quintuple.venn(
            			...
            			raise.error('Invalid size of input object');
            			}
    		    );
            }
		...
		switch(
            ...
            'svg' = {
    			...
    			svg(
    			    ...
    			    raise.error('You have misspelled your "imagetype", please try again');
        			}
		    );

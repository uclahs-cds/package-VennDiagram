...
draw.sp.case.preprocess <- function(
    ...
    a.x <- list(
        '012AA' = c(0,0.3,0.5,0,0.5,0.7,0),
        '111A' = c(0.27,0.5,0.68,0,0,0.76,0),
        '011O' = c(0.175,0,0.825,0.325,0.5,0.675,0),
        '021AA' = c(0.2,0.5,0.8,0,0.5,0,0),
        '033' = c(0,0,0,0,0.5,0,0),
        '010' = c(0.18,0,0.82,0.32,0.5,0.68,0.5),
        '110' = c(0.175,0.375,0.5,0,0,0.625,0.825),
        '112AA' = c(0,0.34,0.5,0,0,0.66,0),
        '011A' = c(0.2,0.425,0.875,0,0.575,0.725,0),
        '100' = c(0.31,0.495,0.68,0.41,0,0.59,0.5),
        '001' = c(0.3,0.5,0.7,0.32,0.5,0.68,0)
        );

    a.y <- list(
        '012AA' = c(0,0.5,0.775,0,0.5,0.5,0),
        '111A' = c(0.5,0.5,0.705,0,0,0.5,0),
        '011O' = c(0.5,0,0.5,0.5,0.5,0.5,0),
        '021AA' = c(0.5,0.675,0.5,0,0.5,0,0),
        '033' = c(0,0,0,0,0.5,0,0),
        '010' = c(0.5,0,0.5,0.54,0.51,0.54,0.75),
        '110' = c(0.5,0.5,0.5,0,0,0.5,0.5),
        '112AA' = c(0,0.5,0.725,0,0,0.5,0),
        '011A' = c(0.5,0.5,0.5,0,0.5,0.5,0),
        '100' = c(0.66,0.66,0.66,0.5,0,0.5,0.335),
        '001' = c(0.35,0.33,0.35,0.58,0.55,0.58,0)
        );

    centre.x <- list(
        '012AA' = c(0.4,0.5,0.6),
        '111A' = c(0.32,0.68,0.76),
        '011O' = c(0.35,0.65,0.5),
        '021AA' = c(0.35,0.65,0.5),
        '033' = c(0.5,0.5,0.5),
        '010' = c(0.35,0.65,0.5),
        '110' = c(0.25,0.5,0.75),
        '112AA' = c(0.34,0.5,0.66),
        '011A' = c(0.35,0.65,0.65),
        '100' = c(0.31,0.68,0.5),
        '001' = c(0.4,0.6,0.5)
        );
    ...
    centre.y <- list(
        ...
        '112AA' = c(0.5,0.5,0.5),
        '011A' = c(0.5,0.5,0.5),
        '100' = c(0.66,0.66,0.333),
        '001' = c(0.5,0.5,0.55)
        );

    radii <- list(
        '012AA' = c(0.2,0.35,0.2),
        '111A' = c(0.27,0.27,0.14),
        '011O' = c(0.25,0.25,0),
        '021AA' = c(0.3,0.3,0.12),
        '033' = c(0.4,0.4,0.4),
        '010' = c(0.25,0.25,0.25),
        '110' = c(0.2,0.2,0.2),
        '112AA' = c(0.15,0.35,0.15),
        '011A' = c(0.3,0.3,0.15),
        '100' = c(0.216,0.216,0.216),
        '001' = c(0.25,0.25,0)
        );
